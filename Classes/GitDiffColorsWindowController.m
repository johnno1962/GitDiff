...
- (instancetype)initWithPluginBundle:(NSBundle *)bundle {
    ...
    if (!nibPath) {
        if ( [[NSAlert alertWithMessageText:@"GitDiff Plugin:"
                  ...
                  informativeTextWithFormat:@"Could not load colors interface. This is a problem when using Alcatraz since Xcode6. If problems persist, please download GitDiff and build from the sources on GitHub. This will install the plugin manually."]
